...
---
### Structure of House Dalianis

All citizens of **House Dalianis** are aligned with either one of the **baronies** or the **Promethic Collective**. These main political entities are composed of several subsidiaries, each contributing to different aspects of House operations. Like other Houses, Dalianis engages in a wide variety of markets, specializing in **ships, drones, and weaponry**. However, they also excel in sectors such as **shoes, furniture, publishing, tools**, and advanced **gravitics technology**.

House Dalianis’ internal organization takes a **nostalgic approach**, with a structure that resembles a more **feudal society**. Titles are awarded based on **Rep**:

- **Lords and Ladies** (Rep 8–9)  
- **High Lords and High Ladies** (Rep 10–11)  
- **Barons or Baronesses** among the baronies  
- **Dukes or Duchesses** within the Promethic Collective  

These titles grant individuals privileges within the House, where **commoners** are expected to bow or curtsy and defer to the Dalianis nobility, even over high-Rep members from other Houses.
