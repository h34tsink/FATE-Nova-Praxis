...
- **Former House Tsarya Digital Asset**
- **[[Savant]] Programmer Turned Revolutionary**
- **Died for the Apostate Cause**
- **"I know where all the digital bodies are buried."**
- **[[Apotheosis|Apotheosized]]**

## Sleeve Aspects
- **Synthetic Biology**
- **Enhanced Neural Interface**
- **Stealth-Modified Systems**
...
- **Digital Spider** *(Bonus on Extranet research)*
- **System Slip** *(Enhanced virtual infiltration)*
...
- **Enhanced Neural Interface** *(SINC processing boost)*
- **Stealth Mods** *(Reduced detection)*

## Gear *(When Alive)*
- **Light Rail Pistol** *(WR: 3, Armor Penetrating, Small)*
- **Stealth Suit** *(AR: 2, Stealth bonus)*
- **Hacking Tools and Custom Hardware**

## Combat Stats *(When Alive)*
**Physical Defense:** AR: 2 *(Stealth Suit)*  
**Physical Stress Track:** 5 boxes *(Athletics 2 + Endurance 3)*  
**Mental Stress Track:** 6 boxes *(Cohesion 3 + Resolve 3)*  
**System Stress Track:** 4 boxes *(SINC 4, Savant only)*

---

## Death Circumstances
Valare died when a deal went sour. One of her Talon compatriots turned out to be a Centurion using her friend's sleeve. During the chaos, a grenade went off, and she got spaced. Her sleeve and core were recovered and hidden in the Chickenhawk until the Talons could figure out how to resurrect her.
...
## Campaign Role
Valare can serve multiple roles:
- **Information source** (if resurrected) about both House operations and Talon plans
- **Moral center** showing the corruption that drives people to rebellion
- **Technical asset** with valuable Savant programs for covering tracks
- **Plot device** whose resurrection could dramatically shift faction dynamics

## GM Notes
- **Resurrection scenario**: Recovering and reviving Valare could be a major plot point
- **Dual loyalties**: Her knowledge of both sides makes her incredibly valuable
- **Moral weight**: Her defection represents legitimate grievances against the Coalition
- **Technical expertise**: Provides access to advanced hacking and cover-up capabilities
- **Faction tension**: Her return could complicate relationships with both Houses and Talons

## Conversion Notes
**Original SWADE Stats:** Savant abilities, high stealth/computer skills  
**Changes Made:** 
- Emphasized Savant programming abilities with SINC skill
- Added specific Savant Programs for her specialization
- Converted stealth/hacking focus to FATE equivalents
- Highlighted moral transformation and faction switch
**Mechanical Notes:** 
- SINC 4 represents advanced Savant capabilities
- Networking skills reflect her connections to both sides
- System Stress Track for Savant-specific conflicts