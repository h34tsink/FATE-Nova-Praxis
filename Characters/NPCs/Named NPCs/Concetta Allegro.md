...
Later in the campaign, Allegro contacts the PCs from Earth to offer an escape route in exchange for harvester data. This offer — made from the quarantined planet itself — raises serious questions about what Cipriani knows about the harvesters and why they want that data badly enough to operate from within the most restricted zone in the system.
...
- Connected to both House and apostate networks
- Later offers escape from Earth in exchange for harvester data
- Distrusted by [[Tejun]]
