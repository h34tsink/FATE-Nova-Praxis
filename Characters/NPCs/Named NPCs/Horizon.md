...
Little is known about Horizon's personal history or motivations. What matters is the role: a conduit for mission briefs, extraction plans, and the occasional hard truth about expendable assets. Whether Horizon genuinely cares about the PCs' welfare or views them as tools remains an open question that could develop over the course of the campaign.
...
- Primary point of contact for covert mission briefs
- Represents the 4th Legion's operational authority

## Continuity

- **Source:** Machinations
- **Assumptions:** Name is likely a callsign. Personal details deliberately sparse — handler characters are often defined by function rather than biography.
