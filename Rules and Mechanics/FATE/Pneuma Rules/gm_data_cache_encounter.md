...
- **Decrypt Logs** (Create Advantage / Overcome): **Great (+4)** base. Skills: **SINC, Investigate, Cohesion**.  
  - Success: place *Recovered Fragment* (1 free invoke).  
  - Style: 2 free invokes **or** reduce HPA Attention by 1 tick.
- **Stabilize Fab Bay** (Overcome): **Great (+4)**. Skills: **Crafts/Science, Cohesion, Will**.  
  - Success: unlocks **Replicator Assist** (+2 to one Attunement roll this scene).  
- **Evade Sweep** (Defend/Create Advantage): Opposed by **HPA Sweep +4**. Skills: **Stealth, Deceive, Cohesion (signature damp)**.  
...
- **Test**: **Great (+4)** vs **Tier +2** (e.g., Tier II = +4). Skill: **Will or Cohesion**.  
...
- **Harvest**: **Create Advantage (SINC or Cohesion)** against **Good (+3)**. On success, place *Signature Breadcrumb [sig=XXXX:YYYY]*.  
...
- Offer **Cohesion** as the “make it hold together” button. Will = force. SINC = syntax. Cohesion = *keep the lie polite*.
